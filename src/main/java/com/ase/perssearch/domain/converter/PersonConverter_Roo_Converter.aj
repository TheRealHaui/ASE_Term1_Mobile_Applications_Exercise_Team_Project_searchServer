...
import com.ase.perssearch.domain.converter.PersonConverter;
...
privileged aspect PersonConverter_Roo_Converter {
    ...
    declare @type: PersonConverter: @FacesConverter("com.ase.perssearch.domain.converter.PersonConverter");
